        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <table class="table table-bordered table-hover" style="background-color:white;">
                ...
                <tr>
                    ...
                    <td>
                        <a href="/toEditor?id=${groupDoc.docId}&&userId=${user.id}"><button type="button" class="btn btn-primary btn-xs">在线编辑</button></a>
                        <button type="button" class="btn btn-primary btn-xs">预览</button>
            ...
            <table class="table table-bordered table-hover" style="background-color:white;">
                ...
                <tbody id="tbody">
                <#if groupUserDoc??&&(groupUserDoc?size>0)>
                <#list groupUserDoc as groupUserDoc>
                <tr>
                    <td>
                        ${groupUserDoc.docName}
                    </td>
                    <td>
                        ${groupUserDoc.groupName}
                    </td>
                    <td>
                        <a href="/toEditor?id=${groupUserDoc.docId}&&userId=${user.id}"><button type="button" class="btn btn-primary btn-xs">在线编辑</button></a>
                        <button type="button" class="btn btn-primary btn-xs">预览</button>
                        <button type="button" class="btn btn-primary btn-xs">下载</button>
                    </td>
                </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/addGroupDoc?id=${(user.id)!}" method="post" enctype="multipart/form-data">
                            <div class="radio">
                                <label>
                            ...
                            <div class="checkbox">
                                ...
                                <label>
                                    <#if group??&&(group?size>0)>
                                        <#list group as group>
                                              <label><input type="checkbox" name="groupId" id="checkbox" value="${group.id}">${group.groupname}</label>
                                        </#list>
                                    </#if>
                                </label>
                            </div>
        ...
        <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/addUserDoc?id=${(user.id)!}" method="post" enctype="multipart/form-data">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked> 从本地导入
                                </label>
